...
import { ButtonContainer, ContainerInputs, ContainerNumber, ContainerProdctCardPrice, ControlIcons, InputText, InputWrapper, TextProductCard }from 'component/ProductList/partial/style/ProductCardPrice.style';
                        ...
                        <InputWrapper>
                            ...
                            <CustomInput
                                onChange={(e) => setEdit({
                                    ...
                                    girino: edit.girino,
                                    id: edit.id
                                  })} value={edit.via} placeholder={'Via'} type={'text'} id='via' />
                        </InputWrapper>
                    ...
                    {edit.isEditing ?
                        <InputWrapper>
                            ...
                            <CustomSelect
                                ...
                                id='tipo'
                                defaultValue={edit.girino} onChange={(e) => setEdit({
                                    isEditing: true,
                                    name: edit.name,
                                    via: edit.via,
                        ...
                        : <ContainerNumber><span>Tipo:</span>{girini && girini.filter((item, key) =>
                            item.id === props.girino
                        )[0].name}
                        </ContainerNumber>}
                </ContainerInputs>
                <ButtonContainer>
                    ...
                    <Button onClick={() => patchToDbItemActive(props.id,props.isActive)}> {props.isActive ? 'Disabilita' : 'Abilita'}</Button>
                </ButtonContainer>
            </ContainerProdctCardPrice>
        </>
    );
